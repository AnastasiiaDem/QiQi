  ...
  return (
    <>
      <div className="flex flex-col">
        <section
          className="items-start bg-[#000709] flex w-full flex-col px-16 py-12 max-md:w-full max-md:px-5">
          <div
            ...
            <h2 className="justify-center text-slate-50 text-4xl font-bold mt-16 max-lg:text-3xl max-md:mt-10">
              Harmony in Nature, Innovation in Science. QiQi believe that beauty should transcend traditional boundaries, and our
        ...
        <section className="bg-[#000709] p-16 max-md:px-5">
          ...
          <div className="flex flex-wrap mx-auto my-16 w-[80%] gap-16 max-md:flex-col max-md:mt-10">
            <QaItem
              title="Are Quantum Skincare products suitable for all skin types?"
              answer="Yes, our products are designed to work their cosmic magic on all skin types."
            />
            <QaItem
              title="Do you test on animals?"
              answer="Never. Our commitment to the universe extends to all its inhabitants."
            />
            <QaItem
              title="Are your products safe for sensitive skin?"
              answer="Absolutely. Our advanced formulations are as gentle as they are potent."
            />
            <QaItem
              title="Where can I buy your products?"
              answer="Here in our online store. Our products ship worldwide!"
            />
          </div>
        </section>
      </div>
