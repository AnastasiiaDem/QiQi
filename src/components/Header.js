...
export default function Header() {
  ...
  return (
    <>
      ...
      <header
        className="fixed z-10 top-0 mix-blend-difference overflow-hidden flex w-full items-center gap-5 p-8 justify-between text-white max-md:w-full max-md:flex-wrap max-md:px-5">
