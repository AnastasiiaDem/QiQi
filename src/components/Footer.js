...
export default function Footer() {
  return (
    <div className="bg-[#000709] flex w-full flex-col justify-center items-center max-md:w-full max-md:px-5">
      <section className="flex w-[80%] pb-5 px-16 pt-20 justify-between gap-4 max-md:mt-10 max-md:px-5 max-md:w-full">
        <div className="flex flex-col">
          ...
          {/*<Link to="#" className={navUndertext}>Conditioner</Link>*/}
        </div>
        <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          ...
          {/*<Link to="#" className={navUndertext}>Press</Link>*/}
        </div>
      </section>
      ...
      <div className="flex flex-col items-center mt-20 p-14 max-md:mt-10 max-md:px-5">
        <img
          loading="lazy"
          src='https://drive.google.com/uc?id=1z6oaPM7Pkr-raKUnMo_sSfBwrU0C-557'
